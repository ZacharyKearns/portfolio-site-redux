...
class About extends Component {
  ...
  render () { // https://github.com/caljrimmer/portfolio-redux-app
    ...
    return (
      <div>
      	  ...
      	  <div className="about">
      	  	...
      	  	<p>You can get the code base from <a href="">my github repo</a>.</p>
	      ...
	      <div className="repos">
	      	<h3><a href="https://github.com/zacharykearns/?tab=repositories" target="_blank">My GitHub</a> Repos</h3>
